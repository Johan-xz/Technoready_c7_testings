const nearbyCitiesService = require('../src/services/nearbyCitiesService');

describe('nearbyCitiesService.findNearbyCities', () => {
  test('devuelve nodos y distancias desde coordenadas dadas', () => {
    const result = nearbyCitiesService.findNearbyCities(25.6866, -100.3161);
